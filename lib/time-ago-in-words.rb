# taken wholesale from https://github.com/Sirupsen/time-ago-in-words/blob/master/lib/time-ago-in-words.rb
...
class Time
  ...
  def time_ago_in_words
    ...
    unit = unit.to_s.downcase + ('s' if time_difference.to_i > 1)
